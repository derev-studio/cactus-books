...
(function () {
  ...
  const I18N = {
    brand: { ru: "🌵 Кактусярий", en: "🌵 Cactusarium", jp: "🌵 Кактусярий", it: "🌵 Cactusarium", zh: "🌵 仙人掌园", es: "🌵 Cactusarium", de: "🌵 Kakteenarium", fr: "🌵 Cactusarium", he: "🌵 Кактусярий" },
    ...
    sources_ack_species_data: { ru: "Данные о видах частично из выгрузки GBIF.org (коллекция UNAM, Мексика) и из NCBI Taxonomy. Цитирование GBIF см. выше (DOI). Благодарим GBIF, UNAM и NCBI.", en: "Species data partly from GBIF.org (UNAM collection, Mexico) and NCBI Taxonomy. See GBIF citation above (DOI). We thank GBIF, UNAM and NCBI.", uk: "Дані про види частково з GBIF.org (колекція UNAM) та NCBI Taxonomy. Дякуємо GBIF, UNAM та NCBI.", es: "Datos de especies en parte de GBIF.org (colección UNAM, México) y NCBI Taxonomy. Citación GBIF arriba (DOI). Agradecemos a GBIF, UNAM y NCBI.", zh: "物种数据部分来自 GBIF.org（UNAM 收藏）和 NCBI Taxonomy。感谢 GBIF、UNAM 和 NCBI。", he: "נתוני מינים חלקית מ-GBIF.org ו-NCBI Taxonomy. תודה ל-GBIF, UNAM ו-NCBI." },
    sources_ack_morphology: { ru: "Морфология и фотографии в карточках взяты из статей Wikipedia (en.wikipedia.org). Авторские права — авторам и Wikipedia/Commons; использование в соответствии с правилами повторного использования контента Wikipedia. Благодарим авторов и проект Wikipedia.", en: "Morphology and photos in cards from Wikipedia articles. Credits to authors and Wikipedia/Commons; use per Wikipedia reuse policy. We thank the authors and Wikipedia.", uk: "Морфологія та фото з Wikipedia. Подяка авторам та Wikipedia.", es: "Morfología y fotos en las fichas proceden de Wikipedia. Créditos a autores y Wikipedia/Commons. Agradecemos a los autores y a Wikipedia.", zh: "形态与照片来自维基百科。感谢作者与维基百科。", he: "מורפולוגיה ותמונות מ-Wikipedia. תודה למחברים ול-Wikipedia." },
    sources_ack_names: { ru: "Названия и синонимы частично из World Flora Online (WFO). Цитирование: WFO (2024). World Flora Online. Благодарим WFO и контрибьюторов.", en: "Names and synonyms partly from World Flora Online (WFO). Citation: WFO (2024). World Flora Online. We thank WFO and contributors.", uk: "Назви та синоніми частково з World Flora Online. Дякуємо WFO.", es: "Nombres y sinónimos en parte de World Flora Online (WFO). Citación: WFO (2024). Agradecemos a WFO y colaboradores.", zh: "名称与同义词部分来自 World Flora Online。感谢 WFO。", he: "שמות ומילים נרדפות מ-World Flora Online. תודה ל-WFO." },
    sources_ack_other: { ru: "Справочно использованы также LLIFLE, ITIS. Все перечисленные источники указаны в целях атрибуции и благодарности.", en: "Also used for reference: LLIFLE, ITIS. All sources listed for attribution and thanks.", uk: "Додатково використано LLIFLE, ITIS. Усі джерела вказані для атрибуції.", es: "También se han usado como referencia LLIFLE e ITIS. Todas las fuentes se indican para atribución y agradecimiento.", zh: "参考来源还包括 LLIFLE、ITIS。所列来源均用于署名与致谢。", he: "בנוסף שימוש ב-LLIFLE, ITIS. כל המקורות לצורך ייחוס ותודה." },
    ...
    nav_geography: { ru: "Места обитания", en: "Habitats", jp: "生息地", it: "Habitat", zh: "生境", es: "Hábitats", de: "Lebensräume", fr: "Habitats", he: "סביבות מחיה" },
    nav_care: { ru: "Здоровье кактуса", en: "Cactus care", jp: "サボテンの手入れ", it: "Cura del cactus", zh: "仙人掌养护", es: "Cuidado del cactus", de: "Kakteenpflege", fr: "Soins des cactus", he: "טיפול בקקטוס" },
    nav_identify: { ru: "Опознать кактус", en: "Identify cactus", jp: "サボテンを同定", it: "Identifica cactus", zh: "识别仙人掌", es: "Identificar cactus", de: "Kaktus bestimmen", fr: "Identifier un cactus", he: "זיהוי קקטוס" },
    ...
    nav_main: { ru: "Главная", en: "Main", jp: "メイン", it: "Home", zh: "首页", es: "Inicio", de: "Start", fr: "Accueil", he: "עמוד ראשי" },
    nav_navigator: { ru: "Навигатор по кактусам", en: "Cactus navigator", jp: "サボテン案内", it: "Navigatore cactus", zh: "仙人掌导航", es: "Navegador de cactus", de: "Kakteen-Navigator", fr: "Navigateur cactus", he: "ניווט קקטי" },
    nav_book: { ru: "Кактусология", en: "Cactology", jp: "カクトゥス学", it: "Cactologia", zh: "仙人掌学", es: "Cactología", de: "Kaktologie", fr: "Cactologie", he: "קטולוגיה" },
    nav_great: { ru: "Великие кактусоводы", en: "Great cactologists", jp: "偉大なサボテン学者", it: "Grandi cactofili", zh: "著名仙人掌学者", es: "Grandes cactólogos", de: "Große Kakteensammler", fr: "Grands cactophiles", he: "חוקרי קקטי דגולים" },
    nav_relax: { ru: "Отдых", en: "Rest", jp: "休息", it: "Relax", zh: "休息", es: "Descanso", de: "Ruhe", fr: "Repos", he: "מנוחה" },
    nav_draw: { ru: "Рисование", en: "Drawing", jp: "絵", it: "Disegno", zh: "绘画", es: "Dibujo", de: "Zeichnen", fr: "Dessin", he: "ציור" },
    nav_succulents: { ru: "Суккуленты", en: "Succulents", jp: "多肉植物", it: "Succulente", zh: "多肉植物", es: "Suculentas", de: "Sukkulenten", fr: "Succulentes", he: "סוקולנטים" },
    nav_edible: { ru: "Съедобные кактусы", en: "Edible cacti", jp: "食用サボテン", it: "Cactus commestibili", zh: "可食仙人掌", es: "Cactus comestibles", de: "Essbare Kakteen", fr: "Cactus comestibles", he: "קקטי אכילים" },
    nav_rarities: { ru: "Редкости", en: "Rarities", jp: "希少種", it: "Rarità", zh: "珍品", es: "Rarezas", de: "Raritäten", fr: "Raretés", he: "נדירים" },
    nav_facts: { ru: "Интересные факты", en: "Interesting facts", jp: "豆知識", it: "Curiosità", zh: "趣闻", es: "Datos curiosos", de: "Interessante Fakten", fr: "Faits intéressants", he: "עובדות מעניינות" },
    nav_caution: { ru: "Осторожно", en: "Caution", jp: "注意", it: "Attenzione", zh: "注意", es: "Precaución", de: "Vorsicht", fr: "Attention", he: "זהירות" },
    ...
    search_placeholder: { ru: "Название кактуса…", en: "Cactus name…", jp: "サボテン名…", it: "Nome cactus…", zh: "仙人掌名称…", es: "Nombre del cactus…", de: "Kakteenname…", fr: "Nom du cactus…", he: "שם קקטוס…" },
    search_btn: { ru: "Найти", en: "Find", jp: "検索", it: "Cerca", zh: "查找", es: "Buscar", de: "Suchen", fr: "Rechercher", he: "חפש" },
